        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="post">
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="firstName" name="first_name" class="border rounded w-full py-2 px-3 focus:outline-none focus:ring focus:border-blue-300 <?php echo (!empty($data['first_name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['first_name']; ?>">
                    <span class="invalid-feedback"><?php echo $data['first_name_err']; ?></span>
                </div>
                <div>
                    <label for="lastName" class="block text-gray-600">Last Name:</label>
                    <input type="text" id="lastName" name="last_name" class="border rounded w-full py-2 px-3 focus:outline-none focus:ring focus:border-blue-300 <?php echo (!empty($data['last_name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['last_name']; ?>">
            ...
            <div class="flex justify-between items-center mb-4">
                <a href="<?php echo URLROOT; ?>/users/login" class="text-blue-500">Login?</a>
